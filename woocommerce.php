            ...
            <div class="row">
                <div class="col-lg-9 order-2 order-lg-1 order-sm-1">
                    ...
                    <div class="single-banner shop-page-banner">
                        <a href="#">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-banner/2.jpg" alt="Li's Static Banner">
                        </a>
                    </div>
                                    ...
                                    <div class="row">
                                                        ...
                                                        <div class="single-product-wrap">
                                                            ...
                                                            <div class="product_desc">
                                                                <div class="product_desc_info">
                                                                    ...
                                                                    <h4><a class="product_name" href="single-product.html"><?php the_title(); ?></a></h4>
                                                                    <div class="price-box">
                                                                ...
                                                                <div class="add-actions">
                                                                    <ul class="add-actions-link">
                                                                        ...
                                                                        <li>
                                                                            <a href="#" title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a>
                                                                        </li>
                                                                        <li>
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/1.jpg"
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/2.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/3.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/4.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/5.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/6.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/7.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/8.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="single-product.html">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/large-size/9.jpg"
                                                             alt="Li's Product Image">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                    ...
                    <div class="sidebar-categores-box">
                        ...
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-categori"><a href="#">40x60cm (6)</a>
                                        </li>
                                        <li><input type="checkbox" name="product-categori"><a href="#">60x90cm (6)</a>
                                        </li>
                                        <li><input type="checkbox" name="product-categori"><a href="#">80x120cm (6)</a>
                                        </li>
                                    </ul>
                                </form>
                            </div>
